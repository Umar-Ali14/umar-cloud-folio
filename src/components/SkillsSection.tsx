          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Git', 'GitHub Actions', 'Nginx', 'MySQL', 'PostgreSQL', 'VS Code', 'Vim', 'SSH'].map((skill) => (
                <span 
                  key={skill}
                  className="px-4 py-2 bg-secondary text-muted-foreground rounded-lg text-sm font-medium hover:bg-primary/10 hover:text-primary transition-all duration-300 cursor-default hover:shadow-[0_0_15px_hsl(var(--primary)/0.2)]"
                >
                  {skill}
                </span>
              ))}
