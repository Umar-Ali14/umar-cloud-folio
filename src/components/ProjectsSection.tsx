        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <AnimatedSection 
              ...
              delay={index * 100}
            >
              <div className="glass-card overflow-hidden group transition-all duration-500 h-full">
                ...
                <div className={`h-32 bg-gradient-to-br ${project.color} opacity-80 flex items-center justify-center relative overflow-hidden`}>
                  <project.icon className="w-16 h-16 text-white/90 transition-transform duration-500 group-hover:scale-110" />
